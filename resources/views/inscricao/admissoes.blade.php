...
@section('title', 'Candidatos admitidos e não admitidos')

@section('conteudo')
<main id="main" class="main">
    <div class="row">
        <div class="col">
            <h2>Admitidos e não admitidos</h2>      
        </div>
    ...
    <table class="table table-striped" style="margin-top: 10px;">
        ...
        <tbody>
            <tr>
                ...
                <td>Fernando João Manuel</td>
                <td>Masculino</td>
                <td>16</td>
                <td>15</td>
                <td>Informática</td>
                <td><span style="font-weight: 600; color: green;">Admitido</span></td>
                <td>
            ...
            <tr>
                <th scope="row">0000000KJ111198</th>
                <td>Maria Luiza</td>
                <td>Feminino</td>
                <td>10</td>
                <td>15</td>
            ...
            <div class="corpo-modal">
                ...
                <div class="dados-pessoais">        
                    ...
                    <div class="container">
                        ...
                        <a href="edt-candidato.html" class="btn" style="background-color: #d0ff00; color: #fff;">Editar dados</a>
                        <div class="jnt">
