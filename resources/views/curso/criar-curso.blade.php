    ...
    <form id="regFormh" action="{{route('cadastrar.curso')}}" class="formulario-layout" method="POST">
        ...
        <div class="tab">
            ...
            <div class="form-group">
                <input type="text" id="letra" style=" text-align: center;" value="{{old('nome_curso')}}" placeholder="Nome do Curso" name="nome_curso" id="nome_curso" oninput="this.className = ''" required >
            ...
            <div class="form-group">
                <input type="text" id="sigla" style=" text-align: center;" value="{{old('sigla_curso')}}"  placeholder="Sigla do Curso" name="sigla_curso"  oninput="this.className = ''" maxlength="4" required>
